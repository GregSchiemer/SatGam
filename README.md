...
This project renders a synchronised multiplayer interface using ES6 canvas animation and gesture-triggered audio. It was designed as a [concert app](https://satellitegamelan.com) to perform microtonal music created by the [developer](https://www.xenharmonikon.org/2024/09/13/an-extended-interview-with-greg-schiemer/) to perform music that explored microtonal tuning theories of Partch and Wilson. This version supports a work that explores harmonic properties of a tuning system with 25 equally spaced intervals, devised by Karlheinz Stockhausen for his 1954 electronic work Studie II. It is intended as an eventual replacement of the original version which written in Objective-C. It uses a combination of javaScript and Csound WebAssembly that draws on the work of New Zealand composer and computer music pioneer Barry Vercoe.
