...
This project renders a synchronised multiplayer interface using ES6 canvas animation and gesture-triggered audio synthesised via Csound WebAssembly. It was designed principally as a concert app for performing microtonal music composed by the developer. The combination of javaScript and Csound WebAssembly is intended as an eventual replacement of the original version of the Satellite Gamelan written app in Objective-C. The UI is designed for a portrait-mode mobile screen (`390×844`).
...
[This video link shows how to set up the tp-link AX73 wireless router]([https://www.tp-link.com/au/support/setup-video/#wi-fi-routers](https://youtu.be/5nZY1M_RH-k))
